  ...
  return (
    <div className="flex flex-col gap-4">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/60 sticky top-0">
                ...
                <th className="text-right px-4 py-3 font-medium text-zinc-500 dark:text-zinc-400 font-mono">
                  ELO
                </th>
                <th className="text-right px-4 py-3 font-medium text-zinc-500 dark:text-zinc-400 hidden sm:table-cell">
                  Votes
                </th>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className="relative w-8 h-8 flex-shrink-0">
                          {getLogoUrl(college.slug) ? (
                            <Image
                              src={getLogoUrl(college.slug)!}
                              alt={college.name}
                              width={32}
                              height={32}
      ...
      <p className="text-xs text-zinc-400 dark:text-zinc-600 text-center">
        {colleges.length} colleges &middot; Community-powered ELO rankings
      </p>
    </div>
  );
}
